            ...
            foreach ($res as $row) {
                ...
                $actions = '
                        <form method="POST">
                            ...
                            <button type="submit" name="package_recalculate" class="btn btn-prom" title="' . lang("package_recalculate_tooltip", "This only recalculates weapon and rank actions") . '">' . lang("package_recalculate", "Recalculate actions") . '</button>

                            <button type="button" name="package_set_inactive" class="btn btn-warning" data-toggle="modal" data-target="#inactiveModal_' . $id . '">' . lang("inactive_everyone", "Set inactive for everyone") . '</button>

                            <button type="button" name="package_set_active" class="btn btn-warning" data-toggle="modal" data-target="#activeModal_' . $id . '">' . lang("active_everyone", "Set active for everyone") . '</button>
        ...
        if ($ret == null) {
            ...
            if (!empty($array)) {
                foreach ($array as $key => $value) {
                    ...
                    $json['datasets'][0]['data'][] = $value;
                    $json['datasets'][0]['backgroundColor'][] = '#' . $colour;
                    $json['labels'][] = $label;
                }
            }
