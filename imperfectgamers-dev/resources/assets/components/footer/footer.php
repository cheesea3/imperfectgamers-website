...
<div class="container" style="user-select: none">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
            ...
            <p ><a  href="/">Imperfect and Company</a>  &copy; <?php print date("Y");?>. All right Reversed.<a class="ml-2" style="color: white" href="https://imperfectcreators.org/" target="_blank">Privacy Policy</a></p>
        </div>
    </div>
</div>
